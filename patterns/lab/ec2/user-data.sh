...
sudo yum install java-17-amazon-corretto -y >> /home/app_data/appinstalllog.txt
echo "Installed JAVA" >> /home/app_data/appinstalllog.txt
export JAVA_HOME=/usr/lib/jvm/java-17-amazon-corretto
export PATH=$PATH:$JAVA_HOME/bin 
wget -P /home/app_data https://cloudarchitect.jfrog.io/artifactory/libs-release/student-services-security-0.0.1-SNAPSHOT.jar >> /home/app_data/appinstalllog.txt
sudo chmod 777 student-services-security-0.0.1-SNAPSHOT.jar >> /home/app_data/appinstalllog.txt
echo "Downloaded Jar Ready to execute..." >> /home/app_data/appinstalllog.txt 
