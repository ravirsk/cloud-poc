...
if ((Get-Website -Name "$sampleAppSiteName").Id -eq $null) {
    ...
    New-IISSite -Name "$sampleAppSiteName" -BindingInformation "*:443:" -PhysicalPath "$binariesDir" -CertificateThumbPrint "$sslCertThumbprint" -CertStoreLocation "Cert:\LocalMachine\My" -Protocol https
